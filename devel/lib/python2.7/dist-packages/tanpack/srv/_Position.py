...
"""autogenerated by genpy from tanpack/PositionRequest.msg. Do not edit."""
import codecs
import sys
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from tanpack/PositionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class PositionResponse(genpy.Message):
  ...
  _type = "tanpack/PositionResponse"
  _has_header = False  # flag to mark the presence of a Header object
