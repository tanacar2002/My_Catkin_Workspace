...
int main(int argc,char** argv)
{
    ...
    vertices.emplace_back(-25.0f,50.0f,MOVEMENT_HEIGHT);
    vertices.emplace_back(-25.0f,0.0f,MOVEMENT_HEIGHT);
    vertices.emplace_back(-25.0f,-50.0f,MOVEMENT_HEIGHT);
    vertices.emplace_back(-25.0f,0.0f,MOVEMENT_HEIGHT);
    vertices.emplace_back(-25.0f,50.0f,MOVEMENT_HEIGHT);
    vertices.emplace_back(-30.0f,22.0f,MOVEMENT_HEIGHT);
    vertices.emplace_back(-30.0f,22.0f,WATER_HEIGHT);
    vertices.emplace_back(-30.0f,22.0f,WATER_HEIGHT);
    vertices.emplace_back(-30.0f,22.0f,WATER_HEIGHT);
    vertices.emplace_back(-35.0f,30.0f,MOVEMENT_HEIGHT);
    vertices.emplace_back(-35.0f,-9.0f,MOVEMENT_HEIGHT);
    vertices.emplace_back(-33.5f,-9.0f,WATER_HEIGHT);
    vertices.emplace_back(-33.5f,-9.0f,WATER_HEIGHT);
    vertices.emplace_back(-33.5f,-9.0f,WATER_HEIGHT);
    vertices.emplace_back(-25.0f,-50.0f,MOVEMENT_HEIGHT);
    vertices.emplace_back(0.0f,0.0f,MOVEMENT_HEIGHT);
