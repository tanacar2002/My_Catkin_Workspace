...
(cl:defmethod cl:initialize-instance :after ((m <tanmsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'tanmsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tanpack-msg:<tanmsg> is deprecated: use tanpack-msg:tanmsg instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <tanmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tanpack-msg:x-val is deprecated.  Use tanpack-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <tanmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tanpack-msg:y-val is deprecated.  Use tanpack-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <tanmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tanpack-msg:z-val is deprecated.  Use tanpack-msg:z instead.")
  (z m))
